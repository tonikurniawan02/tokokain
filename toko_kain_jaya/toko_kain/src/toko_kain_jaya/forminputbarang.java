...
public class forminputbarang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        thargajual.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        thargajual.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                thargajualKeyTyped(evt);
            }
        });
        jPanel1.add(thargajual, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 230, 30));

        tkdbarang.setEditable(false);
        tkdbarang.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        tkdbarang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tkdbarangActionPerformed(evt);
            }
        });
        jPanel1.add(tkdbarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 70, 230, 30));

        tnamabarang.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        tnamabarang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tnamabarangKeyTyped(evt);
            }
        });
        jPanel1.add(tnamabarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 230, 30));

        tjumlahbarang.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        tjumlahbarang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tjumlahbarangKeyTyped(evt);
            }
        });
        jPanel1.add(tjumlahbarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 230, 30));

        thargabeli.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        thargabeli.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                thargabeliKeyTyped(evt);
            }
        });
        jPanel1.add(thargabeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 230, 30));
        ...
        jPanel1.add(bedit, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 210, 100, 30));
        ...
        jPanel1.add(bsimpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 210, 100, 30));
        ...
        jPanel1.add(bhapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 210, 100, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 290, 770, 180));
        ...
        jPanel1.add(tcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 70, 270, 30));
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, 200, -1));
        ...
        jLabel8.setText("Toko Kain Jaya");
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        if(tkdbarang.getText().equals("") ||tnamabarang.getText().equals("") || tjumlahbarang.getText().equals("")|| thargabeli.getText().equals("")|| thargajual.getText().equals("")){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Data berhasil tersimpan", "kain jaya", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try {
            ...
            thargajual.setText("");
            bsimpan.setEnabled(true);
            JOptionPane.showMessageDialog(null, "Data berhasil diubah", "kain jaya", JOptionPane.INFORMATION_MESSAGE);
        }
        }
